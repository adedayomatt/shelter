...
<?php
if(!empty($_GET['shid'])){$pagetitle = $_GET['shid']; }else{$pagetitle = "unknown";}
...
$managerId = $detail['uploadby'];	
		...
		echo "<br/><br/><p align=\"center\">No property with the ID <b>".$shid."</b>. It may have been deleted or banned.<br/>If you think this is an error, please  <a href=\"\">Report Now</a></p>";
		exit();
	}
	}
		else{
...
$executegetManagerDetail = mysql_query($getManagerDetail,$db_connection);
		...
		while($ManagerDetail = mysql_fetch_array($executegetManagerDetail,MYSQL_ASSOC)){
	...
	echo "<br/><br/><p align=\"center\">No property detail to display<br/>see the recently available properties  <a href=\"index.php\">here</a></p>";
exit();
}
...
<div id="image-tray">
<?php  
echo checkForImage($shid.'_01.png');
echo checkForImage($shid.'_02.png');
echo checkForImage($shid.'_03.png');
echo checkForImage($shid.'_04.png');
?>
</div>
<div id="detail-tray">
<div id="details-tab">
