...
//computed data
    ...
    $short_address = $general->substring($location,'abc',30);
...
//set availability
$availability = ($avail == 'Available'? "<span title=\"This property is available\"><span class=\"glyphicon glyphicon-check\"></span>Available</span>":"<span title=\"This property has been leased out\"><span class=\"glyphicon glyphicon-remove\"></span>Leased Out</span>");
